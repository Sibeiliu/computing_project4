...
starting<-   c(-28,0,0.015,0.009,0,0.01,1,0.1,1)
chain <- matrix(NA, nrep, length(starting))
parameter=starting
for(i in 1:nrep) {
newx <- componentwiseMHstep(df_train[1000,],parameter, a=c(0.001,0.00001,0.00001,0.01,0.001,0.01,0.01,0.02,0.0003))
chain[i,] <- newx
parameter <- newx}
...
p <- c(paste0('plot_fluc',1:9))
  for(i in 1:9){
  assign(p[i],ggplot(data = df_chain[4500:5000,], aes_string(x = index[4500:5000], y = df_chain[4500:5000,i]))  +
    geom_line() + 
    ggtitle(var_name[i]) + theme(plot.title = element_text(hjust = 0.5)))
    get(p[i])
  }
